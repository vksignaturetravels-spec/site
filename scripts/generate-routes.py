...
def booking_form(from_val='', to_val='', fare='—'):
    ...
    return f'''<form id="booking-form" class="booking-form">
      ...
      <p class="form-note">No payment on this page. Tolls, bata and parking confirmed on WhatsApp. Minimum billing: 130 km one-way · 250 km round trip (to and fro, ₹1/km less). We usually reply within 15 minutes.</p>
...
<section class="fleet section" id="fleet">
  ...
  <p class="fare-note">Seating is passengers + driver. Round trip is ₹1/km less than one-way. Confirm final fare and charges before booking.</p>
</section>
...
<section class="faq section" id="answers">
  ...
  <div class="questions">
    ...
    <details><summary>How is round trip priced?</summary><p>Round trip is ₹1 per km less than the one-way rate for the same car. Confirm the total fare, driver allowance, tolls, parking and any other applicable charges before accepting a trip.</p></details>
